...
namespace punto.Controllers
{
    public class PagoController : Controller
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Crear(tbpago nuevo)
        {
        ...
        public ActionResult editar(int id)
        {
            ...
            var conjunto = db.tbpago.Find(id);
            if (conjunto == null)
                Redirect("index");
            return View(conjunto);
        }
        [HttpPost]
        public ActionResult editar(tbpago edit)
        {
            ViewBag.salida = 0;
            if (ModelState.IsValid)
            {
                //la mejor forma
                db.Entry<tbpago>(edit).State = System.Data.EntityState.Modified;
                //la tradicional
