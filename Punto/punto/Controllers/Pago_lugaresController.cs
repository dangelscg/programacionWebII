...
{
    public class Pago_lugaresController : Controller
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Crear(tbpagolugares nuevo)
        {
        ...
        public ActionResult editar(int id)
        {
            ...
            var conjunto = db.tbpagolugares.Find(id);
            if (conjunto == null)
                Redirect("index");
            return View(conjunto);
        }
        [HttpPost]
        public ActionResult editar(tbpagolugares edit)
        {
            ViewBag.salida = 0;
            if (ModelState.IsValid)
            {
                //la mejor forma
                db.Entry<tbpagolugares>(edit).State = System.Data.EntityState.Modified;
                //la tradicional
